...
namespace UnitTest.Application.UnitTest.FactoryTest
{
    ...
    {
		[Fact]
		public void AdminFactoryCreation_ShouldReturnSuccess_WhenGivenCorrectBooking()
		{
			// Arrange
            ...
            // Act
            IResult<Booking> result = factory.AdminCreate(dto);
        ...
        [Fact]
        public void GuestFactoryCreation_ShouldReturnSuccess_WhenGivenCorrectInfo()
		{
            // Arrange
            BookingFactory factory = new BookingFactory();
            CreateBookingByGuestFactoryDto dto = new CreateBookingByGuestFactoryDto
			{
				...
				Resource = new Resource("Gaia", "Telt", 100, 5, ""),
				StartDate = DateOnly.FromDateTime(DateTime.Now),
				EndDate = DateOnly.FromDateTime(DateTime.Now.AddDays(1)),
				TotalPrice = 100
			};
            ...
            // Act
            IResult<Booking> result = factory.GuestCreate(dto);
